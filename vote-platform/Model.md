...
![BPMN Diagram](BPMN_vote-platform_diagram.png)
...
![Use Case Diagram](vote-platform/Models/UML/Use_Case_Model.puml)
...
Общая Sequence diagram: ![Sequence Diagram](Models/IMGs/sequence_diagram.png)

## 1. Схема базы данных (Сущности и их атрибуты)
...
### 1.5 PollResultCache (Кэш результатов)
#### 1.5.1 Краткое описание
...
# 2. Дополнительные компоненты системы
### 2.1 Проверка права голоса
...
### 2.2 Реальное время (≤ 4 сек задержки)
...
```
# 5. Масштабируемость (до 100 000 голосов за 5–10 мин)
...
# 13. Swagger
![Swagger](Models/Swagger/Get_Pools.yaml)